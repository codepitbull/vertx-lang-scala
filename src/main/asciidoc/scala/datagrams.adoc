...
// Send a Buffer
socket.send(buffer, 1234, "10.0.0.1", .onComplete {
    case Success(result) => println("Success")
    case Failure(throwable) => println("Failure")
  }
)
// Send a String
socket.send("A string used as content", 1234, "10.0.0.1", .onComplete {
    case Success(result) => println("Success")
    case Failure(throwable) => println("Failure")
  }
)
...
----
var socket = vertx.createDatagramSocket(DatagramSocketOptions())
socket.listen(1234, "0.0.0.0", .onComplete {
    case Success(result) => {
...
socket.send(buffer, 1234, "230.0.0.1", .onComplete {
    case Success(result) => println("Success")
    case Failure(throwable) => println("Failure")
  }
)
...
socket.listen(1234, "0.0.0.0", .onComplete {
    case Success(result) => {
      ...
      socket.listenMulticastGroup("230.0.0.1", .onComplete {
          case Success(result) => println("Success")
          case Failure(throwable) => println("Failure")
        }
      )
    ...
    case Success(result) => {
      ...
      socket.listenMulticastGroup("230.0.0.1", .onComplete {
          case Success(result) => {
            ...
            socket.unlistenMulticastGroup("230.0.0.1", .onComplete {
                case Success(result) => println("Success")
                case Failure(throwable) => println("Failure")
              }
            )
...
socket.blockMulticastGroup("230.0.0.1", "10.0.0.2", .onComplete {
    case Success(result) => println("Success")
    case Failure(throwable) => println("Failure")
  }
)
