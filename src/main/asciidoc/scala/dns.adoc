...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.lookup("vertx.io", .onComplete {
    case Success(result) => {
      println(ar.result())
    }
    case Failure(throwable) => {
      println(s"Failed to resolve entry${ar.cause()}")
    }
  }
)
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.lookup4("vertx.io", .onComplete {
    case Success(result) => {
      println(ar.result())
    }
    case Failure(throwable) => {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.lookup6("vertx.io", .onComplete {
    case Success(result) => {
      println(ar.result())
    }
    case Failure(throwable) => {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveA("vertx.io", .onComplete {
    case Success(result) => {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveAAAA("vertx.io", .onComplete {
    case Success(result) => {
      var records = ar.result()
      enhancedForLoop - 
      println(record)
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveCNAME("vertx.io", .onComplete {
    case Success(result) => {
      var records = ar.result()
      enhancedForLoop - 
      println(record)
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveMX("vertx.io", .onComplete {
    case Success(result) => {
      var records = ar.result()
      enhancedForLoop - 
      println(record)
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveTXT("vertx.io", .onComplete {
    case Success(result) => {
      var records = ar.result()
      enhancedForLoop - 
      println(record)
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveNS("vertx.io", .onComplete {
    case Success(result) => {
      var records = ar.result()
      enhancedForLoop - 
      println(record)
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveSRV("vertx.io", .onComplete {
    case Success(result) => {
      var records = ar.result()
      enhancedForLoop - 
      println(record)
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolvePTR("1.0.0.10.in-addr.arpa", .onComplete {
    case Success(result) => {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.reverseLookup("10.0.0.1", .onComplete {
    case Success(result) => {
      var record = ar.result()
      println(record)
    }
