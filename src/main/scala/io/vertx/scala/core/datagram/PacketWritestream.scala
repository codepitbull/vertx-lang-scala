...
*/
  ...
  def exceptionHandler(handler: Throwable => Unit= null): io.vertx.scala.core.datagram.PacketWritestream = {
  ...
  def drainHandler(handler: () => Unit= null): io.vertx.scala.core.datagram.PacketWritestream = {
